...
@keyframes bombRun { 
    ...
    7% { transform: translate(15px, -30px); animation-timing-function: cubic-bezier(0.32, 0, 0.67, 0); } 
    14% { transform: translate(30px, 0); animation-timing-function: cubic-bezier(0.33, 1, 0.68, 1); } 
    21% { transform: translate(45px, -30px); animation-timing-function: cubic-bezier(0.32, 0, 0.67, 0); } 
    28% { transform: translate(60px, 0); animation-timing-function: cubic-bezier(0.33, 1, 0.68, 1); } 
    35% { transform: translate(75px, -30px); animation-timing-function: cubic-bezier(0.32, 0, 0.67, 0); } 
    42% { transform: translate(90px, 0); animation-timing-function: cubic-bezier(0.33, 1, 0.68, 1); } 
    49% { transform: translate(105px, -30px); animation-timing-function: cubic-bezier(0.32, 0, 0.67, 0); } 
    57% { transform: translate(120px, 0); animation-timing-function: cubic-bezier(0.33, 1, 0.68, 1); } 
    64% { transform: translate(135px, -30px); animation-timing-function: cubic-bezier(0.32, 0, 0.67, 0); } 
    71% { transform: translate(150px, 0); animation-timing-function: cubic-bezier(0.33, 1, 0.68, 1); } 
    78% { transform: translate(165px, -30px); animation-timing-function: cubic-bezier(0.32, 0, 0.67, 0); } 
    85% { transform: translate(180px, 0); animation-timing-function: cubic-bezier(0.33, 1, 0.68, 1); } 
    92% { transform: translate(200px, -20px); animation-timing-function: cubic-bezier(0.32, 0, 0.67, 0); } 
    100% { transform: translate(220px, 20px); opacity: 0; } 
}
.letter-react { display: inline-block; transform-origin: bottom center; }
.run-bomb-anim { animation: bombRun 3s linear forwards; position: absolute; left: 5px; top: 4px; width: 8px; height: 8px; border-radius: 50%; background-color: #8B0000; z-index: 10; }
@media (prefers-color-scheme: dark) { .run-bomb-anim { background-color: #ef4444; } }
@keyframes letterShock { 
    0% { transform: scale(0.8) translateY(4px); color: #8B0000; text-shadow: 0 0 10px rgba(139, 0, 0, 0.5); }
    60% { transform: scale(1.1) translateY(-1px); color: #8B0000; }
...
@keyframes fadeIn { from { opacity: 0; } to { opacity: 1; } }
    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-stone-50 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <div class="flex flex-col items-end">
                        <div class="relative">
                            <h1 class="text-4xl font-black text-gray-900 dark:text-white tracking-wide leading-none" style="font-family: 'Inter', sans-serif;">
                        ...
                        <div class="text-xs font-bold text-[#8B0000] dark:text-red-500 tracking-[0.6em] uppercase mt-2 opacity-0" style="animation: slideUp 0.8s cubic-bezier(0.16, 1, 0.3, 1) 3.2s forwards, pulse 3s cubic-bezier(0.4, 0, 0.6, 1) 4s infinite;">
                            2030
                        </div>
                    </div>
                </div>
