...
@section('content')
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h2 class="text-3xl font-display font-bold text-gray-900 dark:text-white tracking-tight">Create City</h2>
            <p class="text-gray-500 dark:text-gray-400 mt-1 text-lg">Add a new city to the database.</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nom" id="nom" value="{{ old('nom') }}" required placeholder="e.g. Marrakech" class="pl-10 w-full has-icon">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="titre" id="titre" value="{{ old('titre') }}" required placeholder="e.g. The Red City" class="pl-10 w-full has-icon">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="label" id="label" value="{{ old('label') }}" placeholder="e.g. Historic, Coastal, Popular" class="pl-10 w-full has-icon">
                    </div>
