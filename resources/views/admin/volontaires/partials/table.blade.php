        ...
        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors group">
            ...
            <td class="px-6 py-4 text-right">
                <div class="flex items-center justify-end space-x-3">
                    <button type="button" class="view-btn p-2 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-xl transition-colors cursor-pointer" title="View" data-volontaire='@json($volontaire)'>
                    ...
                    @if($volontaire->cv)
                    <button type="button" 
                            onclick="if(window.premiumModal) window.premiumModal.openCvModal('{{ Storage::url($volontaire->cv) }}')" 
                            class="p-2 text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-900/20 rounded-xl transition-colors" 
