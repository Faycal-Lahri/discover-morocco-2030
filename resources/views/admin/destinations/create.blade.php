...
@section('content')
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h2 class="text-3xl font-display font-bold text-gray-900 dark:text-white tracking-tight">Create Destination</h2>
            <p class="text-gray-500 dark:text-gray-400 mt-1 text-lg">Add a new destination to the database.</p>
        </div>
