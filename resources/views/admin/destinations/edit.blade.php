    ...
    <div class="glass-card rounded-2xl p-8 max-w-5xl mx-auto shadow-xl">
        <form action="{{ route('admin.destinations.update', $destination) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nom" id="nom" value="{{ old('nom', $destination->nom) }}" required placeholder="e.g. Jardin Majorelle" class="pl-10 w-full has-icon">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="titre" id="titre" value="{{ old('titre', $destination->titre) }}" required placeholder="e.g. A beautiful garden" class="pl-10 w-full has-icon">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="label" id="label" value="{{ old('label', $destination->label) }}" placeholder="e.g. Must Visit" class="pl-10 w-full has-icon">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="gps_location" id="gps_location" value="{{ old('gps_location', $destination->gps_location) }}" placeholder="e.g. 31.6258, -7.9891" class="pl-10 w-full has-icon">
                    </div>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="5" placeholder="Write a detailed description..." class="w-full">{{ old('description', $destination->description) }}</textarea>
